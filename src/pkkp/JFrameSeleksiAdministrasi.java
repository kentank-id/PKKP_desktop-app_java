 ...
 */
public class JFrameSeleksiAdministrasi extends javax.swing.JFrame {
     ...
     */
    public JFrameSeleksiAdministrasi() {
        initComponents();
        open_db();
        selectDB();
        setLocation(400, 0);
        ...
        setResizable(false);
        tblSeleksi.setDefaultEditor(Object.class, null);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameSeleksiAdministrasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameSeleksiAdministrasi().setVisible(true);
            }
        });
    }
