 ...
 */
public class JFrameKelurahan extends javax.swing.JFrame {

    // membuat object
    private Connection con;
    private Statement stat;
    private ResultSet res;
    final String querySelect = "SELECT * FROM data_peserta ORDER BY CONVERT(peserta_kelurahan, decimal) DESC";

    /**
     * Creates new form frmKelurahan
     */
    public JFrameKelurahan() {
        initComponents();
        open_db();
        selectDB();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameKelurahan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
