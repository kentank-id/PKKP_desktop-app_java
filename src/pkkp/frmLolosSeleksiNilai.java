 ...
 * @author ROYAN FARID
 */
public class frmLolosSeleksiNilai extends javax.swing.JFrame {
    //create object
    Connection con;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PESERTA LOLOS SELEKSI PENILAIAN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmLolosSeleksiNilai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
