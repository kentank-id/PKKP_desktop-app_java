 ...
 */
public class JFrameLolosNilai extends javax.swing.JFrame {
    //create object
    Connection con;
    ...
    /**
     * Creates new form frmLolosSeleksiNilai
     */
    public JFrameLolosNilai() {
        initComponents();
        open_db();
        selectDB();
    ...
    public void export(JTable table, File file) {
        try {
            TableModel m = tblLolosNilai.getModel();
    ...
    private void initComponents() {
        ...
        tblLolosNilai = new javax.swing.JTable();
        ...
        jLabel2.setText("GRADES SELECTION");
        jLabel2.setOpaque(true);

        tblLolosNilai.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Kode Peserta", "Nama Peserta", "Nilai Tes Tulis", "Nilai Tes Wawancara", "Total Nilai"
            }
        ) {
        ...
        jScrollPane1.setViewportView(tblLolosNilai);
    ...
    private void cmdCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdCetakActionPerformed
        ...
        try {
            export(tblLolosNilai, new File("Laporan_Lolos_Nilai.xls"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameLolosNilai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameLolosNilai().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblLolosNilai;
