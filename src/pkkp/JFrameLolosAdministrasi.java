 ...
 */
public class JFrameLolosAdministrasi extends javax.swing.JFrame {
    //create object
    Connection con;
     ...
     */
    public JFrameLolosAdministrasi() {
        initComponents();
        open_db();
        selectDB();
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        setLocation(400, WIDTH);
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Adminstrative Selection");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameLolosAdministrasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
